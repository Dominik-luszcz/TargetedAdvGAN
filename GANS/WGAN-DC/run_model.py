...
def sample_stats(model: DCGAN, log_returns, num_to_sample, output_dir):
        ...
        with open(f"{output_dir}/sample_stats_wgan.txt", 'a') as file:
            file.write("=" * 50 + "\n")
        ...
        plt.ylabel('Density')
        plt.savefig(f'{output_dir}/wgan_kde.png')
        plt.close()
        ...
        plt.xlabel('Log_return')
        plt.ylabel('Density')
        plt.savefig(f'{output_dir}/wgan_hist.png')
        plt.close()
...
if __name__ == '__main__':
    ...
    model = DCGAN.load_from_checkpoint(r"C:\Users\annal\WGan_A_50\best-model.ckpt")
