...
def train_on_one_stocks(data_files, ticker, num_samples, sample_size, batch_size, num_epochs, output_path, noise_dim,
    ...
    trainer = pl.Trainer(devices='auto', accelerator='auto', accumulate_grad_batches=1, logger=False, callbacks=[train_callback, DCGAN_Callback(dataset.unscaled_returns)], 
                        ...
                        enable_progress_bar=True, max_time='00:06:00:00', default_root_dir=output_path)
...
if __name__ == '__main__':
    ...
    output_path = '/scratch/a/alim/dominik/CWGan_Combo_A_s50'
    initialize_directory(output_path) 

    train_on_one_stocks(data_files="/home/a/alim/dominik/SP500_Filtered", ticker='A', num_samples=500, sample_size=50, batch_size=32, #32 for subsample
          num_epochs=500, output_path=output_path, noise_dim=8,
