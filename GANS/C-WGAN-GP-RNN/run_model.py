...
def train_on_one_stocks(
    ...
    trainer = pl.Trainer(
        ...
        logger=False,
        callbacks=[train_callback, C_WGAN_GP_RNN_Callback(dataset.unscaled_returns)],
...
def plot_loss_functions(model: C_WGAN_GP_RNN, output_path):
    # plot loss
...
def inference_test(model: C_WGAN_GP_RNN, noise_dim):
