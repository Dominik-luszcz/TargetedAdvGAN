...
class SingleStockDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (
            self.log_returns[start - 50 : start],
...
def train_on_one_stocks(
    ...
    trainer = pl.Trainer(
        ...
        logger=False,
        callbacks=[train_callback, C_WGAN_GP_Callback(dataset.unscaled_returns)],
...
def plot_loss_functions(model: C_WGAN_GP, output_path):
...
def inference_test(model: C_WGAN_GP, noise_dim):
