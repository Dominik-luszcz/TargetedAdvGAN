...
def train(data_files, training_split_file, batch_size, num_epochs, output_path, noise_dim,
...
if __name__ == '__main__':
    ...
    output_path = 'DCGan_Ouptuts2'
    initialize_directory(output_path)

    train(data_files="SP500_Filtered", training_split_file='training_split.npy', batch_size=16, #32 for subsample
          num_epochs=100, output_path=output_path, noise_dim=64,
