...
def set_up_dataset(feature_path:str, split_file: str):
    ...
    train_datset = TimeSeriesDataSet(
        ...
        time_varying_unknown_reals=["adjprc","adjprc_rolling_mean5",
                                    "adjprc_rolling_mean10","adjprc_rolling_mean20",
...
if __name__ == '__main__':
    ...
    # Set up the datasets
    train_dataset, val_dataset, test_dataset = set_up_dataset("SP500_Features_sampled_adjprc", "training_split.npy")
